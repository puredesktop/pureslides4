# Develop pureslides and build new apps
...
| Goal | Start here |
| --- | --- |
| Add a feature to pureslides | Fork or clone this repository and prepare its shared dependencies, or select its editable project in purefactory when available. |
...
1. Fork [puredesktop/pureslides](https://github.com/puredesktop/pureslides) if you want your own repository, then clone your fork locally. Create a branch for your change.
